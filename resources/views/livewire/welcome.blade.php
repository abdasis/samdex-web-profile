<div>
    <section class="bg-home bg-image-1" id="home">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="home-title mo-mb-20">
                                <h1 class="mb-4 font-weight-bolder font-48 text-white">Irit Gesit Ekonomis!</h1>
                                <h4 class="text-white font-weight-bolder home-desc mb-5">SAMDEXS Adalah cairan aditive,
                                    hasil fermentasi
                                    bahan nabati yang di kemas dan dipasarkan di dalam negeri dan luar
                                    negeri oleh PT. SILA SUKSES BERSAMA. </h4>
                                <div class="subscribe">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-8">
                                            ...
                                            <div class="col-md-4">
                                                <button type="submit" class="btn btn-danger font-weight-bold">Subscribe
                                                    Us</button>
                                            </div>
                                        </div>
                                    </form>
    ...
    {{-- <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('assets/images/display-samdexs-1.jpg') }}" class="d-block w-100" alt="...">
</div>
<div class="carousel-item">
    <img src="{{ asset('assets/images/display-samdexs-2.jpg') }}" class="d-block w-100" alt="...">
</div>
<div class="carousel-item">
    <img src="{{ asset('assets/images/foto-samdexs-kemasan.jpg') }}" class="d-block w-100" alt="...">
</div>
</div>
        ...
        <div class="clients p-4 bg-white">
            <div class="row ">
                <div class="col-md-4 text-center ">
                    <div class="client-images animate__bounce">
                        <i class="fa fa-award fa-4x"></i>
                        <h4>Bahan Terjamin</h4>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="client-images animate__bounce">
                        <i class="fa fa-oil-can fa-4x"></i>
                        <h4>Mudah Digunakan</h4>
                    </div>
                </div>
                <div class="col-md-4 text-center">
                    <div class="client-images animate__bounce">
                        <i class="fa fa-tachometer-alt fa-4x"></i>
                        <h4>Performa Meningkat</h4>
                    </div>
                </div>
            </div> <!-- end row -->
        </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="embed-responsive embed-responsive-16by9">
                    <iframe class="embed-responsive-item" src="{{ asset('assets/images/samdexs-opening.mp4') }}"
                        allowfullscreen></iframe>
                </div>
            </div>
            <div class="col-md-7">
                <h1 class="font-weight-bold">PT. Sila Sukses Bersama</h1>
                <p>PT. Sila Sukses Bersama didirikan pada tahun 2020 berlokasi di Pondok Mutiara-Blok S- No.20-Sidoarjo
                    – Jawa Timur, yang
                    bergerak dibidang perdagangan, dengan menciptakan inovasi yang menarik dan sesuai misi perusahaan
                    yang mengutamakan mutu
                    dan kepuasan pelanggan dan mitra kerja.</p>
                <p><span class="font-weight-bolder font-14 text-redca">Misi:</span> Mengutamakan mutu dan keandalan
                    pelayanan untuk kepuasan pelanggan
                    dan mitra kerja</p>
                <p><span class="font-weight-bolder font-14 text-redca">Visi:</span> Menjadi perusahaan perdagangan yang
                    terbaik dan tangguh</p>
                <h3 class="text-motto">"Selalu menciptakan dan berinovasi pekerjaan yang halal dan berkah"</h3>
            </div>
            <!-- end col -->
        </div>
        <!-- end row -->
...
<!-- manfaat start -->
<section class="section py-5 bg-image-2" id="pricing">
    <div class="bg-shape">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="text-center mb-4">
                    <h3 class="text-white">Manfaat</h3>
            ...
            <div class="col-xl-10">
                <div class="row align-items-start">
                    <div class="col-lg-4">
                        <div class="pricing-plan bg-white p-4 mt-4">
                            <div class="pricing-header text-center">
                                <h5 class="plan-title text-uppercase mb-4">MENINGKATKAN BAHAN BAKAR & PENGHEMATAN</h5>
                            </div>
                            <ul class="list-unstyled pricing-list mt-4">
                                <li>
                                    <p><i class="mdi mdi-check-circle"></i> Mengurangi getaran</p>
                                </li>
                                <li>
                                    <p><i class="mdi mdi-check-circle"></i> Menambah tenaga & akselerasi</p>
                                </li>
                                <li>
                                    <p> <i class="mdi mdi-check-circle"></i> Meningkatkan Angka Oktana 5-10 RON (Bensin)
                                    </p>
                                </li>
                                <li>

                                    <p><i class="mdi mdi-check-circle"></i> Menghemat BBM hingga 45%</p>
                                </li>
                                <li>

                                    <p><i class="mdi mdi-check-circle"></i> Menyempurnakan Pembakaran</p>
                                </li>
                                <li>

                                    <p> <i class="mdi mdi-check-circle"></i> Suara menjadi lebih halus</p>
                                </li>
                            </ul>
                        </div>
                    </div> <!-- end col -->
                    ...
                    <div class="col-lg-4">
                        <div class="pricing-plan bg-white p-4 mt-4">
                            <div class="pricing-header text-center">
                                <h5 class="plan-title text-uppercase mb-4">PERAWATAN MESIN</h5>
                            </div>
                            <ul class="list-unstyled pricing-list mt-4">
                                <li>
                                    <p><i class="mdi mdi-check-circle"></i> Memperpanjang perawatan mesin</p>
                                </li>
                                <li>
                                    <p><i class="mdi mdi-check-circle"></i> Membersihkan dengan Fuel Line System</p>
                                </li>
                                <li>
                                    <p> <i class="mdi mdi-check-circle"></i> Sebagai anti microorganisme</p>
                                </li>
                                <li>

                                    <p><i class="mdi mdi-check-circle"></i> Menghilangkan residu karbon serta kandungan
                                        sedimen</p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="pricing-plan bg-white p-4 mt-4">
                            <div class="pricing-header text-center">
                                <h5 class="plan-title text-uppercase mb-4">RAMAH LINGKUNGAN</h5>
                            </div>
                            <ul class="list-unstyled pricing-list mt-4">
                                <li>
                                    <p><i class="mdi mdi-check-circle"></i> Menghilangkan emisi gas CO hingga 100%</p>
                                </li>
                                <li>
                                    <p><i class="mdi mdi-check-circle"></i> Mengurangi Emisi karbon.</p>
                                </li>
                                <li>
                                    <p> <i class="mdi mdi-check-circle"></i> Mereduksi emisi gas buang</p>
                                </li>
                            </ul>
                        </div>
                    </div> <!-- end col -->
        ...
        <div class="row align-items-center mt-5">
            <div class="col-lg-6">
                <div class="p-5 features-content">
                    ...
                    <p class="text-muted mb-4">
                        Everyone realizes why a new common language would be desirable one could refuse to expensive
                        translators it would be necessary.
                    </p>
                    <a href="#" class="btn btn-primary btn-sm">Learn More <i class="mdi mdi-arrow-right"></i></a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-5 offset-lg-1">
                ...
                <div>
                    ...
                    <p class="faq-answer mb-4 pb-1 text-muted">Lorem Ipsum is simply dummy text of the printing and
                ...
                <div>
                    ...
                    <p class="faq-answer mb-4 pb-1 text-muted">Lorem ipsum dolor sit amet, in mea nonumes dissentias
                        dissentiunt, pro te solet oratio iriure. Cu sit consetetur moderatius intellegam, ius decore
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="title text-center mb-4">
                    ...
                    <p class="text-white-50">Please fill out the following form and we will get back to you shortly
                    </p>
                </div>
            </div>
        </div>
