<div>
    <!-- home start -->
    <section class="bg-home bg-image-2" id="home">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="home-title mo-mb-20">
                                <h1 class="mb-4 text-dark">Irit Gesit Ekonomis!</h1>
                                <p class="text-dark home-desc mb-5">SAMDEXS Adalah cairan aditive, hasil fermentasi
                                    bahan nabati yang di kemas dan dipasarkan di dalam negeri dan luar
                                    negeri oleh PT. SILA SUKSES BERSAMA. </p>
                                <div class="subscribe">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-8">
                        ...
                        <div class="col-xl-4 offset-xl-2 col-lg-5 offset-lg-1 col-md-7">
                            <div class="home-img position-relative">
                                <img src="{{ asset('assets/images/foto-samdexs-kemasan.jpg') }}" class="w-100" alt=""
                                    srcset="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="features-box">
                        ...
                        <p class="text-muted">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit
                        </p>
                    </div>
                </div>
                <!-- end col -->
                ...
                <div class="col-lg-4">
                    <div class="features-box">
                        ...
                        <p class="text-muted">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                        </p>
                    </div>
                </div>
                <!-- end col -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="features-box">
                        ...
                        <p class="text-muted">At solmen va esser necessi far uniform grammatica pronun e plu sommun
                            paroles.</p>
                    </div>
                </div>
                <!-- end col -->
                <div class="col-lg-4">
                    <div class="features-box">
                        ...
                        <p class="text-muted">If several languages coalesce the grammar of the is more simple languages.
                        </p>
                    </div>
                </div>
                <!-- end col -->
