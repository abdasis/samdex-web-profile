            ...
            <div class="row mb-5">
                <div class="col-lg-4">
                    <div class="pr-lg-4">
                        ...
                        <p class="text-white-50">Ubold is a fully featured premium admin template built on top of
                            awesome Bootstrap 4.1.3, modern web technology HTML5, CSS3 and jQuery.</p>
                    </div>
                </div>
